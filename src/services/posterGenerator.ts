...
export function buildPosterHtml(input: BuildPosterInput): string {
  ...
  const nfcBig = '<svg class="nfc-big-svg" viewBox="0 0 100 100" fill="none" stroke="currentColor" stroke-width="4.5" stroke-linecap="round" stroke-linejoin="round"><rect x="56" y="24" width="36" height="54" rx="7"/><line x1="67" y1="31" x2="81" y2="31"/><path d="M43 37 A14 14 0 0 1 43 65"/><path d="M32 30 A21 21 0 0 1 32 72"/><path d="M21 23 A28 28 0 0 1 21 79"/></svg>';
