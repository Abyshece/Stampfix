...
const POSTER_DE: [string, string][] = [
  ['<h1 class="ly-headline">Your Loyalty<br>Card</h1>', '<h1 class="ly-headline">Deine Digitale<br>Treuekarte</h1>'],
  ...
  ['<span class="or">OR</span>', '<span class="or">ODER</span>'],
...
<style>
  ...
  *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
  ...
  .size-loyalty .ly-pb { position: absolute; top: 44px; left: 58px; display: flex; align-items: center; gap: 4px; font-size: 11px; font-weight: 700; color: var(--ink); opacity: 1; z-index: 3; }
  ...
  .size-loyalty .ly-card { position: absolute; left: 40px; right: 40px; bottom: -34px; max-width: none; width: auto; margin: 0; background: __CARD_BG__; color: __CARD_INK__; border: none; border-radius: 26px; padding: 30px 28px 40px; gap: 24px; box-shadow: 0 -14px 44px rgba(0,0,0,0.30); }
  ...
  .size-loyalty .ly-card .dc-shape { width: 52px; height: 52px; }
  ...
  .scan-qr { line-height: 0; }
  .scan-qr svg { width: 150px; height: 150px; display: block; }
  .size-poster .scan-qr svg { width: 160px; height: 160px; }
...
<body data-size="__SIZE__">
  ...
  <div class="size-loyalty">
    ...
    <div class="ly-top">
      <h1 class="ly-headline">Your Loyalty<br>Card</h1>
    ...
    <div class="ly-scan">
      ...
      <div class="ly-div"><span class="ln"></span><span class="or">OR</span><span class="ln"></span></div>
